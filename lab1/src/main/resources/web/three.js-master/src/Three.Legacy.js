...
Object.assign( Box2.prototype, {
	...
	areIntersectingionBox: function ( box ) {

		console.warn( 'THREE.Box2: .areIntersectingionBox() has been renamed to .intersectsBox().' );
...
Object.assign( Box3.prototype, {
	...
	areIntersectingionBox: function ( box ) {
		...
		console.warn( 'THREE.Box3: .areIntersectingionBox() has been renamed to .intersectsBox().' );
		return this.intersectsBox( box );

	},
	areIntersectingionSphere: function ( sphere ) {

		console.warn( 'THREE.Box3: .areIntersectingionSphere() has been renamed to .intersectsSphere().' );
...
Plane.prototype.areIntersectingionLine = function ( line ) {

	console.warn( 'THREE.Plane: .areIntersectingionLine() has been renamed to .intersectsLine().' );
...
Object.assign( Ray.prototype, {
	...
	areIntersectingionBox: function ( box ) {
		...
		console.warn( 'THREE.Ray: .areIntersectingionBox() has been renamed to .intersectsBox().' );
		return this.intersectsBox( box );

	},
	areIntersectingionPlane: function ( plane ) {

		console.warn( 'THREE.Ray: .areIntersectingionPlane() has been renamed to .intersectsPlane().' );
		return this.intersectsPlane( plane );

	},
	areIntersectingionSphere: function ( sphere ) {

		console.warn( 'THREE.Ray: .areIntersectingionSphere() has been renamed to .intersectsSphere().' );
		return this.intersectsSphere( sphere );
